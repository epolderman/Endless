...
public class ControlMapping : MonoBehaviour 
{
    ...
    private static readonly string[] key = {"Right Click", "Left Click", "A" ,"B" ,
                            "C", "D" ,"E", "F", "G", "H", "I", "J", 
                            "K", "L", "M", "N","O", "P","Q", "R", "S", 
    ...
    //ps4 keys
    private static readonly string[] keyPS4 = {"Square","X", "Circle", "Triangle", "L1", 
                               "L2", "R1", "R2", "Share","Options", 
                               "L3", "R3", "PS", "PadPress"};

    //xbox keys
    private static readonly string[] keyXbox = {"A","B","X","Y","Left Bumper","Right Bumper", 
    ...
    private string ps3pc = "PLAYSTATION(R)3 Controller";
    ...
    void Start()
    {
            ...
            if(scriptFinder.iverson.Xmoveleft != "" && scriptFinder.iverson.ps4moveleft != "")
            {
                Debug.Log("--Mapping Controls Across Scenes--");
    ...
    public void CheckControllerPluggedIn()
    {
        ...
        for (int i = 0; i < Input.GetJoystickNames().Length; i++)
        {
            ...
            else if (ps4name == Input.GetJoystickNames()[i] || ps4mac == Input.GetJoystickNames()[i] || ps3pc == Input.GetJoystickNames()[i])
            {
                Debug.Log("Controller Name: " + Input.GetJoystickNames()[i]);
    ...
    public void mapBindings()
    {
        ...
        //Debug.Log("FinalIndi " + FinalIndieMap.moveBack.name);
        //Debug.Log("BackMapButton " + backmap.GetComponentInChildren<Text>().text);
        ...
        if (ps4 == true)
        {
            ...
            Debug.Log("Mapping PLAYSTATION as Active Controller");
            MapPS4Active();
    ...
    //returns the first unused mapping starting at the beginning -> solves edge case of last string in array
    ...
    { 
        //not saving keyboard ones

    
        //get hud booleans here
